"""Verify emails on catch-all domains with deterministic verification. Powered by Enrow."""

from typing import Any, Dict, List, Optional

import httpx

__all__ = ["verify_catch_all", "get_verification_result", "verify_catch_all_bulk", "get_verification_results"]
...
def verify_catch_all(
    api_key: str,
    email: str,
    custom: Optional[str] = None,
    webhook: Optional[str] = None,
) -> Dict[str, Any]:
    """Start a single catch-all email verification. Returns a dict with an 'id' to poll for results."""
...
def verify_catch_all_bulk(
    api_key: str,
    emails: List[str],
    custom: Optional[str] = None,
    webhook: Optional[str] = None,
) -> Dict[str, Any]:
    """Start a bulk catch-all email verification. Returns a dict with a 'batchId' to poll for results."""
    body: Dict[str, Any] = {
        "emails": emails,
    }
    if custom:
